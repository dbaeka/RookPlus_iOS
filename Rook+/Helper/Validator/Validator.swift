...
public class Validator {
    ...
    */
    ...
    /**
     ...
     - returns: Validator
     */
    public static func hasSpecialCharacter(nilResponse: Bool = false) -> Validator {
        return !self.regex(Regex.AlphanumericRegex, nilResponse: nilResponse) && !equals("", nilResponse: nilResponse)
    }
