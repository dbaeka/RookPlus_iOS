...
extension String {
    ...
    func format(string: String, with format: String) -> String {
        let oldString = string
        let stringUnformated = self.unformat(string: oldString, with: format)
    ...
    func unformat(string: String, with format: String) -> String {
        let oldString = string
